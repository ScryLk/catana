...
interface DiPackConfeiteriaProps {
  width?: number;
  height?: number;
...
/**
 * Componente de Catálogo de Confeitaria DiPACK
 * Template moderno com produtos de confeitaria
 */
export const DiPackConfeitariaV2: FC<DiPackConfeiteriaProps> = ({
  width = 794,
  height = 1123,
  pageNumber = 1,
  ...
  return (
    <div
      className="DiPackConfeiteria relative bg-white"
      style={{
        width: `${width}px`,
        height: `${height}px`,
        padding: '32px',
            ...
            <div className="w-24 flex-shrink-0 flex items-center justify-center mr-3">
              {product.imageUrl ? (
                <img
                  ...
                  // crossOrigin="anonymous" // Removed to avoid potential local file issues
