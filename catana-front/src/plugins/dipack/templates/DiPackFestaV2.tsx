...
/**
 * Componente de Catálogo de Linha de Festa DiPACK
 * Template moderno com produtos para festas e eventos
 */
export const DiPackFestaV2: FC<DiPackFestaProps> = ({
  width = 794,
  height = 1123,
  ...
  return (
    <div
      className="DiPackFesta relative bg-white"
      style={{
        width: `${width}px`,
        height: `${height}px`,
        padding: '32px',
