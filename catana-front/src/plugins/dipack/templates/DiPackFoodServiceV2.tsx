...
interface DiPackFoodServiceProps {
  width?: number;
  height?: number;
  pageNumber?: number;
...
/**
 * Componente de Catálogo de Food Service DiPACK
 * Template moderno com produtos para Food Service
 */
export const DiPackFoodServiceV2: FC<DiPackFoodServiceProps> = ({
  width = 794,
  height = 1123,
  ...
  return (
    <div
      className="DiPackFoodService relative bg-white"
      style={{
        width: `${width}px`,
        height: `${height}px`,
        padding: '32px',
